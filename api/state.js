...
async function getState() {
  ...
  } catch (e) { return { _source: 'error', _error: e.message }; }
}
...
async function saveState(state) {
  ...
  await put(STATE_FILENAME, JSON.stringify(state), { access: 'public', addRandomSuffix: false, allowOverwrite: true, token });
  return state;
}
